...
/**
 @generated
 */
public class CadsegContentItemCreationPageCadsegContentItem_CreationPage extends
		PageImpl {
	...
	/**
	    @generated
	 */
	protected CadsegContentItemCreationPageCadsegContentItem_CreationPage(
	...
	/**
	    @generated
	 */
	public CadsegContentItemCreationPageCadsegContentItem_CreationPage(
			Item parent, ItemType it, LinkType lt) {
		super("creation-page-CadsegContentItem", "Create CadsegContentItem",
				"Create CadsegContentItem", "", false, 3);
		this.parent = parent;
		this.it = it;
		this.lt = lt;
